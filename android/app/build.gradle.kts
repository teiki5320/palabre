...
// Clé de téléversement Play : android/key.properties et android/app/upload-keystore.jks,
// jamais dans le dépôt (mot de passe dans le trousseau macOS « Palabre Android upload keystore »).
...
android {
    ...
    buildTypes {
        release {
            // Signée avec la clé de téléversement si elle est présente ; sinon (CI) avec la clé de debug.
