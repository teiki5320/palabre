...
class _AccueilEcranState extends ConsumerState<AccueilEcran> {
  ...
  Widget build(BuildContext context) {
    ...
    // dès que le contenu est là montrerait une fraction de seconde comme
    // verrouillé un parcours que le joueur a déjà gagné.
    return Scaffold(
      body: SafeArea(
        child: contenu.when(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(14),
            border: Border.all(
              color: choisi ? const Color(0xFFE9B44C) : Colors.white24,
              width: choisi ? 2 : 1,
            ),
          ),
          child: Row(
                ...
                child: ColorFiltered(
                  ...
                  child: Image.asset(
                    ...
                    errorBuilder: (_, __, ___) =>
                        Container(width: 64, height: 80, color: const Color(0xFF26222E)),
                  ),
                ),
              ),
