...
class _IntroEcranState extends State<IntroEcran> {
  ...
  static const _panneaux = [
    ...
    (
      ...
      texte: 'Il pose son problème. Vous glissez sa carte à gauche ou à droite : '
          'c\'est votre réponse. Il n\'y a pas de bouton, et pas de « plus tard ».',
    ),
    (
      titre: 'Quatre forces vous tiennent.',
      texte: 'Le peuple, l\'armée, les caisses, la presse. Contentez-en une, '
                  ...
                  for (final p in _panneaux)
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(p.titre, style: Textes.nomParcours),
                          const SizedBox(height: 18),
                          Text(p.texte, style: Textes.sousTitre.copyWith(fontSize: 16, height: 1.5)),
                        ],
                      ),
                    ),
                ],
